  ...
  <?php include('header.php');?>
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <img src="img/conps.jpg" style="width:50%;">
                        <div class="container">
                            <h1>PSVITA</h1>
            ...
            <img src="img/conps2.jpg" style="width:50%;" >
            <div class="container">
                            <h1>PSVITA</h1>
                            <div class="box" style="width: 300px;">
                                <center><p>####</p></center>
            ...
            <div class="carousel-item">
            <img src="img/conps3.jpg" style="width:50%;">
            <div class="container">
                            <h1>PSVITA</h1>
                            <div class="box" style="width: 300px;">
                                <center><p>#####</p></center>
                ...
                while($row = mysqli_fetch_array($result)){?>
                    <div class="col-4">
                        <form method="get" action="game.php?id=<?=$row['id']?>" >
                            <center><a href=""><img src="img/pss.png" style="width: 50%; bottom:20px"></a>
                            <h2 class="text-center"><?=$row['name'];?></h2>
                            <p class="text-center"><?=$row['type'];?></p>
